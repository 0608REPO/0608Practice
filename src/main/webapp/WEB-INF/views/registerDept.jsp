	        ...
	        <td width="450" height="20" align="center">
	        	<b>
	        		<span style="font-size:12pt;">
	        			<input type="text" name="deptno" id="deptno" size="30">
	        		</span>
	        		<br/>
...
<script type="text/javascript">
	const deptnoInput = document.getElementById('deptno');
	const deptnoMsg = document.getElementById('deptnoMsg');
	deptnoInput.addEventListener('blur', () => {
	    axios.get('http://localhost:8082/api/dept/' + deptnoInput.value)
	    	.then(response => { // 부서가 없다면
	    		if(response.data == ''){
	    			deptnoMsg.innerHTML = '새로운 부서번호로 사용할 수 있습니다.';
	    			
	    		}
	    	}) 
	    	.catch(error => { // 부서가 있다면(앞에서 Exception으로 걸러진다)
	    		console.log(error.response.data);
	    		deptnoMsg.innerHTML = '이미 존재하는 부서번호입니다.';
